/**
 * ResultModelOfListOfPerformanceModel.java
 *
...
public class ResultModelOfListOfPerformanceModel  extends at.fh.ooe.swk.ufo.webservice.BaseModel  implements java.io.Serializable {
    private at.fh.ooe.swk.ufo.webservice.PerformanceModel[] result;

    public ResultModelOfListOfPerformanceModel() {
    }
    ...
    /**
     * Gets the result value for this ResultModelOfListOfPerformanceModel.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this ResultModelOfListOfPerformanceModel.
     * 
     * @param result
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResultModelOfListOfPerformanceModel)) return false;
        ResultModelOfListOfPerformanceModel other = (ResultModelOfListOfPerformanceModel) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResultModelOfListOfPerformanceModel.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://webservice.ufo.swk.ooe.fh.at/", "ResultModelOfListOfPerformanceModel"));
