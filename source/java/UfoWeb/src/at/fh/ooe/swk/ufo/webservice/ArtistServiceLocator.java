...
public class ArtistServiceLocator extends org.apache.axis.client.Service implements at.fh.ooe.swk.ufo.webservice.ArtistService {
    ...
    public at.fh.ooe.swk.ufo.webservice.ArtistServiceSoap getArtistServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public at.fh.ooe.swk.ufo.webservice.ArtistServiceSoap getArtistServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            at.fh.ooe.swk.ufo.webservice.ArtistServiceSoapStub _stub = new at.fh.ooe.swk.ufo.webservice.ArtistServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (at.fh.ooe.swk.ufo.webservice.ArtistServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                at.fh.ooe.swk.ufo.webservice.ArtistServiceSoapStub _stub = new at.fh.ooe.swk.ufo.webservice.ArtistServiceSoapStub(new java.net.URL(ArtistServiceSoap_address), this);
                _stub.setPortName(getArtistServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://webservice.ufo.swk.ooe.fh.at/", "ArtistService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://webservice.ufo.swk.ooe.fh.at/", "ArtistServiceSoap"));
        }
